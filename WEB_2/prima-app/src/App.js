...
function App() {
  ...
  //   <div>
  //     <h1>Esercizio 1</h1>
  //     <Messaggio testo="Ciao! Questo è il primo esercizio React!" />
  //     <Messaggio testo="Ecco un altro messaggio con props diverse" />
  //   </div>
  // );
  ...
  //   <div>
  //     <h1>Esercizio 3</h1>
  //     <ListaUtenti utenti={utenti_array} />
  //   </div>
  // );
  ...
  //     <CardUtente
  //       nome="Lolo Landa"
  //       email="lolo.landa2025@email.com"
  //       imgUrl="https://placehold.co/100"
  //     />

  //     <CardUtente
  //       nome="Larry Fisher"
  //       email="superlarry@email.com"
  //       imgUrl="https://placehold.co/120"
  //     />
  //   </div>
  // );
